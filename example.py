...
conn=ps.connect(host='database-1.cspat74yfn24.us-east-1.rds.amazonaws.com', user='admin', passwd='Lalastacks', port=3306, db='NYCAirBnBs', autocommit=True);
...
fig.update_layout(title_font_family="Balto",title_font_size=30,title_font_color='darkred', height=1000, width=1500, title_text="NYC AirBnB Dashboard")
fig.show()
